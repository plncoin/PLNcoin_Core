...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("plncointools.com", "testnet-seed.plncointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.plncoin.loshan.co.uk", true));
